...
//Terrain terrain(-1, -1, 150, 32, "../Textures/mapa.png");
...
std::vector<glm::vec3> lamp2Position = {
	...
	glm::vec3(19.92, 0, -8),
	//glm::vec3(-24.8046, 0, 50.9765),
	glm::vec3( -47.8515, 0, 30.2734), //esta sí
	glm::vec3(-66.6, 0, 45.3125), //esta sí
	glm::vec3( -44.5312, 0,  51.3671)
};
std::vector<float> lamp2Orientation = {
	90+21.37, 90.0 - 65.0, -90 - 22.17, -90 - 50.17, 0 - 15 , 90 + 38.43
};
...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	modelLamp3.loadModel("../models/Lamp3/Street_Lamp_Bulb.obj");
	modelLamp3.setShader(&shaderMulLighting);
	modelLampPost3.loadModel("../models/Lamp3/Street_Lamp_Post.obj");
	modelLampPost3.setShader(&shaderMulLighting);
	...
	//camera->setPosition(glm::vec3(-60.0, 3.0, 45.0));
	...
	//Texture textureG("../Textures/shell.png");
	...
	//Texture textureB("../Textures/agua.png");
	...
	// Definiendo la textura
	//Texture textureBlendMap("../Textures/mapa2.png");
...
/*
		shaderMulLighting.setVectorFloat3("viewPos", glm::value_ptr(camera->getPosition()));
		shaderMulLighting.setVectorFloat3("directionalLight.light.ambient", glm::value_ptr(glm::vec3(0, 0, 0)));
		...
		shaderTerrain.setVectorFloat3("viewPos", glm::value_ptr(camera->getPosition()));
		shaderTerrain.setVectorFloat3("directionalLight.light.ambient", glm::value_ptr(glm::vec3(0, 0, 0)));
		shaderTerrain.setVectorFloat3("directionalLight.light.diffuse", glm::value_ptr(glm::vec3(0.2, 0.2, 0.2)));
		shaderTerrain.setVectorFloat3("directionalLight.light.specular", glm::value_ptr(glm::vec3(0.7, 0.7, 0.7)));
		shaderTerrain.setVectorFloat3("directionalLight.direction", glm::value_ptr(glm::vec3(-1.0, 0.0, 0.0)));
*/
		/*******************************************
		...
		for(int i = lamp2Position.size()+lamp1Position.size(); i < lamp3Position.size()+lamp1Position.size()+lamp2Position.size(); i++){
			glm::mat4 matrixAjustLamp = glm::mat4(1.0f);
		...
		for(unsigned int i = 0; i< lamp3Position.size(); i++){
			...
			modelLamp3.setScale(glm::vec3(1.8));
			modelLamp3.setOrientation(glm::vec3(0,lamp3Orientation[i],0));
			modelLamp3.render();
			modelLampPost3.setPosition(lamp3Position[i]);
			modelLampPost3.setScale(glm::vec3(1.8));
			modelLampPost3.setOrientation(glm::vec3(0,lamp3Orientation[i],0));
			modelLampPost3.render();
		}
