...
Terrain terrain(-1, -1, 200, 15, "../Textures/Nombre-CGA2.png");
...
void applicationLoop() {
	...
	while (psi) {
		...
		*****************************************************/
		...
		modelMatrixAircraft [3][1] = terrain.getHeightTerrain(modelMatrixAircraft[3][0], modelMatrixAircraft[3][2]+2);
		...
		modelMatrixDartBody [3][1] = terrain.getHeightTerrain(modelMatrixDartBody[3][0], modelMatrixDartBody[3][2]+2);
