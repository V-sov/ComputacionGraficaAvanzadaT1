...
//Completando la declaración de partes articuladas → Brazo derecho
...
float rotBuzzHead = 0.0, rotBuzzLeftArm = 0.0, 
rotBuzzLeftForeArm = 0.0, rotBuzzRightForeArm = 0.0,
rotBuzzLeftHand = 0.0, rotBuzzRightArm = 0.0, 
rotBuzzRightHand = 0.0, rotBuzzHip = 0.0,
rotBuzzLeftThigh= 0.0, rotBuzzRightThigh= 0.0, 
rotBuzzRightCalf = 0.0, rotBuzzLeftCalf = 0.0,
rotBuzzRightFoot = 0.0, rotBuzzLeftFoot = 0.0;
//rotBuzzRightWing1 = 0.0, rotBuzzLeftWing1 = 0.0,
//rotBuzzRightWing2 = 0.0, rotBuzzLeftWing2 = 0.0;
...
void applicationLoop() {
	...
	while (psi) {
		...
		// Settea la Matrix de vista y projection al shader con solo color
		shader.setMatrix4("projection", 1, false, glm::value_ptr(projection));
		shader.setMatrix4("view", 1, false, glm::value_ptr(view));

		// Settea la Matrix de vista y projection al shader con skybox
		...
		*******************************************/
		...
		// Helicopter
		glm::mat4 modelMatrixHeliChasis = glm::mat4(modelMatrixHeli);//Matrix padre del todo el movimiento del helicoptero completo
		...
		glm::mat4 modelMatrixHeliRear = glm::mat4(modelMatrixHeliChasis);//que todo movimiento sea heredada a la helices
		modelMatrixHeliRear = glm::translate(modelMatrixHeliRear,glm::vec3(0,2.0936,-5.64942));//el eje x no importa porque está girando ahí
		...
		//modelMatrixDartHead = glm::scale(modelMatrixDartBody, glm::vec3(5, 5, 5));
 ...
 //************************AÑADIDO********************************
		...
		} //Para reproducir el frame vvvvvvvvvv
		//else if(!record && keyFramesDartJoints.size()>0){ //vector de vectores flotantes porque en el archivo se guardan por vectores cada frame
